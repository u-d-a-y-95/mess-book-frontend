  ...
  return (
    <div className="flex bg-white justify-between">
      <div className="flex flex-col" style={{ height: "80vh" }}>
        <div className="flex ">
          <div className="border w-16 p-2 break-all text-sm">Day / Name</div>
          {users?.map((user, index) => (
            <div key={user?.id} className="border w-16 p-2 break-all text-sm">
              {user?.name}
            </div>
          ))}
        </div>
      ...
      <div className="">
        <table className="w-full">
          ...
          <tr>
            ...
            <td className="border p-2 break-words text-sm bg-green-100">60</td>
          </tr>
        </table>
